...
const documentos: Record<string, DocumentModalContent> = {
  ...
  "estatuto-policias": {
    titulo: "ESTATUTO DO INSS — LEI Nº 8.029/1990 E DECRETO Nº 3.048/1999",
    subtitulo: "Organização e funcionamento do Instituto Nacional do Seguro Social",
    corpo: [
      "O Instituto Nacional do Seguro Social (INSS) é uma autarquia federal vinculada ao Ministério da Previdência Social, criado pela Lei nº 8.029, de 12 de abril de 1990, com personalidade jurídica própria, autonomia administrativa e financeira, nos termos da legislação vigente. Tem sede em Brasília/DF e jurisdição em todo o território nacional.",
      "DISPOSIÇÕES GERAIS — O INSS tem por finalidade: conceder e manter os benefícios e serviços previdenciários previstos no Regime Geral de Previdência Social (RGPS); gerir o sistema de arrecadação e fiscalização das contribuições previdenciárias; e garantir a proteção social aos segurados e seus dependentes, nos termos da Lei nº 8.213/1991 e do Decreto nº 3.048/1999.",
      "DO INGRESSO NA CARREIRA — O ingresso nos cargos efetivos do INSS ocorre exclusivamente mediante aprovação em concurso público de provas ou de provas e títulos, nos termos do art. 37, II, da Constituição Federal e da Lei nº 8.112/1990 (Regime Jurídico Único dos Servidores Públicos Civis da União). Os cargos de provimento efetivo integram o Plano de Carreira dos Cargos do Seguro Social.",
      "DA REMUNERAÇÃO — A remuneração dos servidores efetivos do INSS é fixada conforme tabela aprovada pelo Ministério da Previdência Social e pelo Ministério da Gestão e Inovação em Serviços Públicos. São previstos: vencimento básico; auxílio-alimentação (R$ 1.192,00); auxílio-saúde; e demais vantagens previstas na Lei nº 8.112/1990. Para o cargo de Técnico do Seguro Social: vencimento básico de R$ 6.355,13.",
      "DOS DIREITOS — São direitos dos servidores efetivos do INSS: estabilidade no serviço público após estágio probatório de 3 anos; remuneração irredutível; férias de 30 dias anuais com adicional de 1/3; licenças previstas na Lei nº 8.112/1990 (maternidade, paternidade, tratamento de saúde, capacitação); 13º salário; e participação em programas de qualificação profissional.",
      "DOS DEVERES — São deveres dos servidores do INSS: exercer com zelo, dedicação e eficiência as atribuições do cargo; observar o sigilo funcional e as normas de proteção de dados dos segurados (LGPD — Lei nº 13.709/2018); manter conduta ética e compatível com a moralidade pública; atender com urbanidade e presteza os beneficiários; e cumprir as metas de atendimento estabelecidas pela administração.",
      "DO REGIME DISCIPLINAR — Os servidores efetivos do INSS estão sujeitos ao regime disciplinar previsto na Lei nº 8.112/1990, Título IV, que prevê penalidades de: advertência; suspensão; demissão; cassação de aposentadoria ou disponibilidade; e destituição de cargo em comissão — proporcionais à gravidade da infração, assegurados o contraditório, a ampla defesa e o devido processo legal.",
      "DO PROGRAMA DE CAPACITAÇÃO — O INSS promove a formação e o desenvolvimento contínuo de seus servidores por meio da Escola Nacional de Seguro Social (ENAS) e de parcerias com instituições de ensino. São oferecidos cursos de atualização em legislação previdenciária, atendimento ao público, uso de sistemas institucionais e gestão pública.",
      "DA PROGRESSÃO FUNCIONAL — A progressão na carreira dos servidores do INSS ocorre mediante avaliação de desempenho individual e institucional, nos termos do Decreto nº 7.133/2010, podendo resultar em progressão por mérito ou por capacitação, conforme regulamentação específica do Plano de Carreira dos Cargos do Seguro Social.",
    ],
  },
